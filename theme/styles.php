...
$candidatesheet = "{$candidatedir}/" . theme_styles_get_filename($type, $usesvg);
$chunkedcandidatesheet = "{$candidatedir}/" . theme_styles_get_filename($type, $usesvg, $chunk);
$etag = theme_styles_get_etag($themename, $rev, $type, $usesvg, $chunk);
...
function theme_styles_generate_and_store($theme, $rev, $candidatedir) {
    ...
    $candidatesheet = "{$candidatedir}/" . theme_styles_get_filename($type, $theme->use_svg_icons());
 ...
 */
function theme_server_fallback_content($theme, $rev) {
    global $CFG;
    ...
    $filename = theme_styles_get_filename($type, $rev);
 ...
 */
function theme_styles_get_filename($type, $usesvg, $chunk = null) {
    $filename = $type;
 ...
 */
function theme_styles_get_etag($themename, $rev, $type, $usesvg, $chunk) {
