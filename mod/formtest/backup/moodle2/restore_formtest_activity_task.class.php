...
class restore_widget_activity_task extends restore_activity_task {
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('NEWMODULEVIEWBYID', '/mod/widget/view.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('NEWMODULEINDEX', '/mod/widget/index.php?id=$1', 'course');
