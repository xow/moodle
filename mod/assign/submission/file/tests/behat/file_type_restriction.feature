...
Feature: In an assignment, limit submittable file types
  ...
  Scenario: File types validation for an assignment
    ...
    When I set the field "Accepted file types" to "image/png;doesntexist;.fake;unreal/mimetype;nodot"
    And I press "Save and display"
    And I should see "The following file types were not recognised: doesntexist .fake unreal/mimetype nodot"
