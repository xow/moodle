 ...
 *
 * @package    mod_scorm
 * @copyright  2014 onwards Ben Johnson
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class attempt_scored extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' completed or was scored for the attempt with id '{$this->other['attemptid']}' " .
    ...
    public static function get_name() {
        return get_string('eventattemptscored', 'mod_scorm');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'scorm', 'attempt scored', 'report.php?id=' . $this->contextinstanceid,
