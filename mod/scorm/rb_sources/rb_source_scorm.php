        ...
        $columnoptions = array(
            ...
            */
            new rb_column_option(
                'scorm',
                'title',
                get_string('scormtitle', 'report_reportbuilder'),
                'scorm.name',
                array('joins' => 'scorm')
            ),
            new rb_column_option(
                'sco',
                'title',
                get_string('title', 'report_reportbuilder'),
                'sco.title',
                array('joins' => 'sco')
            ),
            new rb_column_option(
                'sco',
                'starttime',
                get_string('time', 'report_reportbuilder'),
            ...
            new rb_column_option(
                'sco',
                'status',
                get_string('scostatus', 'report_reportbuilder'),
            ...
            new rb_column_option(
                'sco',
                'totaltime',
                get_string('totaltime', 'report_reportbuilder'),
            ...
            new rb_column_option(
                'sco',
                'scoreraw',
                get_string('score', 'report_reportbuilder'),
            ...
            new rb_column_option(
                'sco',
                'statusmodified',
                get_string('statusmodified', 'report_reportbuilder'),
            ...
            new rb_column_option(
                'sco',
                'scoremin',
                get_string('minscore', 'report_reportbuilder'),
            ...
            new rb_column_option(
                'sco',
                'scoremax',
                get_string('maxscore', 'report_reportbuilder'),
            ...
            new rb_column_option(
                'sco',
                'attempt',
                get_string('attemptnum', 'report_reportbuilder'),
                'base.attempt'
            ),
        );
        ...
        $filteroptions = array(
            ...
            */
            ...
            new rb_filter_option(
                'sco',
                'starttime',
                get_string('attemptstart', 'report_reportbuilder'),
                'date'
            ),
            new rb_filter_option(
                'sco',
            ...
            new rb_filter_option(
                'sco',
                'scoreraw',
                get_string('rawscore', 'report_reportbuilder'),
                'number'
            ),
            new rb_filter_option(
                'sco',
    ...
    protected function define_contentoptions() {
        ...
        $contentoptions = array(
            /*new rb_content_option(
                ...
                get_string('currentorg', 'report_reportbuilder'),  // title
                'organisation.path',                // field
                'organisation'                      // joins
            ),*/
            new rb_content_option(
                'user',
                get_string('theuser', 'report_reportbuilder'),
                'base.userid'
            ),
            new rb_content_option(
                'date',
                get_string('thedate', 'report_reportbuilder'),
                $DB->sql_cast_char2int('sco_starttime.value', true),
                'sco_starttime'
            ),
        );
    ...
    */
    ...
    function rb_filter_scorm_status_list() {
        ...
        if (!empty($records)) {
            ...
            $statusselect = array(
                'passed' => get_string('passed', 'report_reportbuilder'),
                'completed' => get_string('completed', 'report_reportbuilder'),
                'not attempted' => get_string('notattempted', 'report_reportbuilder'),
                'incomplete' => get_string('incomplete', 'report_reportbuilder'),
                'failed' => get_string('failed', 'report_reportbuilder'),
            );
        }
        return $statusselect;
    }
