...
$string['connecttimeout'] = 'LDAP server connection time-out (in integral seconds). After this many seconds, Moodle will give up trying to connect to the current LDAP server and will failover to the next in the list (if any). If left empty, set to zero or negative value, the default LDAP library time-out will be used.';
$string['connecttimeout_key'] = 'Connection time-out';
$string['connecttimeout_invalid'] = 'Connection time-out must be an integer value';
