 ...
 *
 * vendor/bin/phpunit columns_test report/reportbuilder/tests/column_test.php
 *
 */
...
require_once($CFG->dirroot . '/report/reportbuilder/tests/reportcache_advanced_testcase.php');
