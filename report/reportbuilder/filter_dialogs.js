...
M.report_reportbuilder_filterdialogs = M.report_reportbuilder_filterdialogs || {
    ...
    init: function(Y, args) {
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.report_reportbuilder_filterdialogs.init()-> jQuery dependency required for this module to function.');
        }
    ...
    rb_init_filter_dialogs: function() {
        ...
        $('div.rb-org-add-link a').each(function(i, el) {
            ...
            (function() {
                ...
                totaraMultiSelectDialogRbFilter(
                    id,
                    M.util.get_string('chooseorgplural', 'report_reportbuilder'),
                    url+'find.php?',
        ...
        $('div.rb-pos-add-link a').each(function(i, el) {
            ...
            (function() {
                ...
                totaraMultiSelectDialogRbFilter(
                    id,
                    M.util.get_string('chooseposplural', 'report_reportbuilder'),
                    url+'find.php?',
                    url+'save.php?filtername='+id+'&ids='
                );
        ...
        $('div.rb-comp-add-link a').each(function(i, el) {
            ...
            (function() {
                ...
                totaraMultiSelectDialogRbFilter(
                    id,
                    M.util.get_string('choosecompplural', 'report_reportbuilder'),
                    url+'find.php?',
                    url+'save.php?filtername='+id+'&ids='
                );
        ...
        $('div.rb-cohort-add-link a').each(function(i, el) {
            ...
            (function() {
                var url = M.cfg.wwwroot + '/report/reportbuilder/ajax/';
