...
M.report_reportbuilder_showhide = M.report_reportbuilder_showhide || {
    ...
    init: function(Y, args) {
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.report_reportbuilder_showhide.init()-> jQuery dependency required for this module to function.');
        }
        ...
        var path = M.cfg.wwwroot + '/report/reportbuilder/';
        ...
        totaraDialogs[name] = new totaraDialog(
            ...
            {
                buttons: buttons,
                title: '<h2>' + M.util.get_string('showhidecolumns', 'report_reportbuilder') + '</h2>'
            },
