...
class rb_source_site_logs extends rb_base_source {
    ...
    function __construct() {
        ...
        $this->sourcetitle = get_string('sourcetitle_site_logs', 'report_reportbuilder');
    ...
    protected function define_columnoptions() {
        ...
        $columnoptions = array(
            ...
            new rb_column_option(
                'log',
                'ip',
                get_string('ip', 'report_reportbuilder'),
                'base.ip',
            ...
            new rb_column_option(
                'log',
                'module',
                get_string('module', 'report_reportbuilder'),
                'base.module'
            ),
            new rb_column_option(
                'log',
                'cmid',
                get_string('cmid', 'report_reportbuilder'),
                'base.cmid'
            ),
            new rb_column_option(
                'log',
                'action',
                get_string('action', 'report_reportbuilder'),
                $DB->sql_fullname('base.module', 'base.action')
            ),
            new rb_column_option(
                'log',
                'actionlink',
                get_string('actionlink', 'report_reportbuilder'),
                $DB->sql_fullname('base.module', 'base.action'),
                array(
                    'displayfunc' => 'link_action',
                    'defaultheading' => get_string('action', 'report_reportbuilder'),
            ...
            new rb_column_option(
                'log',
                'url',
                get_string('url', 'report_reportbuilder'),
                'base.url'
            ),
            new rb_column_option(
                'log',
                'info',
                get_string('info', 'report_reportbuilder'),
                'base.info'
            ),
        );
    ...
    protected function define_filteroptions() {
        $filteroptions = array(
            new rb_filter_option(
                'log',     // type
                'action',  // value
                get_string('action', 'report_reportbuilder'),  // label
                'text',    // filtertype
                array()    // options
            )
        );
    ...
    protected function define_contentoptions() {
        $contentoptions = array(
            ...
            new rb_content_option(
                ...
                get_string('currentpos', 'report_reportbuilder'),      // title
                'position.path',                    // field
                'position'                          // joins
            ),
            new rb_content_option(
            ...
            new rb_content_option(
                'date',
                get_string('date', 'report_reportbuilder'),
                'base.time'
            ),
        );
