...
class rb_source_user extends rb_base_source {
    ...
    public function __construct() {
        ...
        $this->sourcetitle = get_string('sourcetitle_user', 'report_reportbuilder');
    ...
    protected function define_columnoptions() {
        ...
        $columnoptions[] = new rb_column_option(
                        'user',
                        'userpicture',
                        get_string('userspicture', 'report_reportbuilder'),
                        'base.id',
                        array(
                            'displayfunc' => 'user_picture',
                            'noexport' => true,
                            'defaultheading' => get_string('picture', 'report_reportbuilder'),
                            'extrafields' => array(
        ...
        $columnoptions[] = new rb_column_option(
                        'user',
                        'userlearningicons',
                        get_string('mylearningicons', 'report_reportbuilder'),
                        'base.id',
                        array(
                            'displayfunc' => 'learning_icons',
                            'noexport' => true,
                            'defaultheading' => get_string('options', 'report_reportbuilder')
                        )
        );
        ...
        $columnoptions[] = new rb_column_option(
                        ...
                        get_string('usersachievedcompcount', 'report_reportbuilder'),
        ...
        $columnoptions[] = new rb_column_option(
                        'statistics',
                        'coursesstarted',
                        get_string('userscoursestartedcount', 'report_reportbuilder'),
        ...
        $columnoptions[] = new rb_column_option(
                        'statistics',
                        'coursescompleted',
                        get_string('userscoursescompletedcount', 'report_reportbuilder'),
        ...
        $columnoptions[] = new rb_column_option(
                        'user',
                        'namewithlinks',
                        get_string('usernamewithlearninglinks', 'report_reportbuilder'),
                        $DB->sql_fullname("base.firstname", "base.lastname"),
                        array(
                            'displayfunc' => 'user_with_links',
                            'defaultheading' => get_string('user', 'report_reportbuilder'),
                            'extrafields' => array(
                                'user_id' => 'base.id',
                                'userpic_picture' => 'base.picture',
                                'userpic_firstname' => 'base.firstname',
    ...
    protected function define_contentoptions() {
        ...
        $contentoptions = array(
            new rb_content_option(
                'user',
                get_string('user', 'report_reportbuilder'),
                'base.id'
            ),
            /*new rb_content_option(
                'current_org',
            ...
            new rb_content_option(
                'date',
                get_string('timecreated', 'report_reportbuilder'),
                'base.timecreated'
            ),
        );
    ...
    function rb_display_user_with_links($user, $row, $isexport = false) {
        ...
        $recordstr = get_string('records', 'report_reportbuilder');
        $requiredstr = get_string('required', 'report_reportbuilder');
        $planstr = get_string('plans', 'report_reportbuilder');
        $profilestr = get_string('profile', 'report_reportbuilder');
        $bookingstr = get_string('bookings', 'report_reportbuilder');
