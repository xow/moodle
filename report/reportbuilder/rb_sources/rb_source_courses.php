...
class rb_source_courses extends rb_base_source {
    ...
    function __construct() {
        ...
        $this->sourcetitle = get_string('sourcetitle_courses', 'report_reportbuilder');
    ...
    protected function define_columnoptions() {
        $columnoptions = array(
            new rb_column_option(
                'course',
                'mods',
                get_string('content', 'report_reportbuilder'),
                "mods.list",
    ...
    protected function define_filteroptions() {
        $filteroptions = array(
            new rb_filter_option(
                'course',         // type
                'mods',           // value
                get_string('coursecontent', 'report_reportbuilder'), // label
    ...
    protected function define_contentoptions() {
        $contentoptions = array(
            ...
            new rb_content_option(
                'date',
                get_string('startdate', 'report_reportbuilder'),
                'base.startdate'
            ),
        );
