 ...
 */
M.report_reportbuilder_cachenow = M.report_reportbuilder_cachenow || {
    ...
    init: function(Y, args){
        ...
        if (typeof $ === 'undefined') {
            throw new Error('M.report_reportbuilder_cachenow.init()-> jQuery dependency required for this module to function.');
        }
        ...
        (function() {
            ...
            $('.show-cachenow-dialog').each(function(ind,inst) {
                id = $(inst).data('id');
                url = M.cfg.wwwroot + '/report/reportbuilder/ajax/cachenow.php?reportid='+id;
                name = 'cachenow';
                ...
                totaraDialogs[name] = new totaraDialog(
                    ...
                    {
                        buttons: buttonObj,
                        title: '<h2>' + M.util.get_string('cachenow_title', 'report_reportbuilder') + '</h2>',
                        width: '500',
                        height: '200',
