...
$string['defaultloginscreen'] = 'Default login screen';
$string['defaultloginscreen_help'] = 'If an identity provider is a more common authentication method, you may wish to select identity provider as the default auth. Otherwise the username/password will appear by default.';
...
$string['identityproviders'] = 'Identity providers';
