...
$cancel      = optional_param('cancel', 0, PARAM_BOOL);      // redirect to frontpage
...
if (isloggedin() and !isguestuser()) {
    ...
    $continue = new single_button(new moodle_url($CFG->wwwroot.'/login/index.php', array('cancel'=>1)), get_string('cancel'), 'get');
