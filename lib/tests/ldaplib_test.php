    ...
    protected function ldap_connect_timeout() {
        $tests = array(
            array(
                ...
                'timeout' => -1,    // Configured timeout (in integral seconds).
                                    // -1 means no timeout (use operating system default timeout).
                'maxexpected' => 2, // Maximum expected elapsed connection/timeout time (in integral seconds).
                                    // Make it a bit higher than the specified timeout,
                                    // to account for additional unknown latency sources.
                'shouldconnect' => true,
            ),
            array(
