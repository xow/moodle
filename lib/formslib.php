...
abstract class moodleform {
    ...
    function moodleform($action=null, $customdata=null, $method='post', $target='', $attributes=null, $editable=true) {
        ...
        $this->_form->addElement('hiddenpassword');
...
MoodleQuickForm::registerElementType('hiddenpassword', "$CFG->libdir/form/hiddenpassword.php", 'MoodleQuickForm_hiddenpassword');
