 ...
 * @param integer $connecttimeout timeout (in integral seconds) for the connection to the LDAP server to be established, before
 *        giving up. If zero or negative, use default timeout.
