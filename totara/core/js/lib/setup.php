...
function local_js($options = array()) {
    ...
    //error_log("THESE ARE THE JS OPTIONS IN /totara/core/js/lib/setup.php");
    ...
    //error_log("FINISHES LOAD OF JQUERY");
    // If UI
    if (in_array(TOTARA_JS_UI, $options)) {
        //error_log("LOADS JQUERY UI");
    ...
    if (in_array(TOTARA_JS_DIALOG, $options)) {
        ...
        $PAGE->requires->strings_for_js(array('save', 'delete'), 'report_reportbuilder');
    ...
    //error_log("FINISHES JQUERY LOADS");
}
